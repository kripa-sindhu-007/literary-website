  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto">
        <h1 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8 text-gray-900 dark:text-gray-100">Welcome to My Literary Corner</h1>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-gray-800 dark:text-gray-200">Latest Works</h2>
        <div className="space-y-8">
          <section>
            <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-700 dark:text-gray-300">Latest Poem</h3>
            <ContentDisplay {...latestPoem} />
          </section>
          <section>
            <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-700 dark:text-gray-300">Latest Short Story</h3>
